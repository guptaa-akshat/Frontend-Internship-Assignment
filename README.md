# Fyle Frontend Challenge- Akshat Gupta

## Challange solutions:-

* Implemented Search by book title or author name
* Paginated results set with a limit of 10 search results per page 
* Added limit and offset to improve search performance
* Clear search text
* Add a Back button to Go back to the home page from the Trending Subject page
* Deployed application

 Please wait for few seconds for search results to appear.
